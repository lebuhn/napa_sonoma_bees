...
Clean data set by 
  correcting spelling for Stag's Leap and Wappo Hill
  preserving a subset of the columns, 
  removing sites that were not sampled in all years and 
  changing start_date to a date class.
